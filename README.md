...
4. Then import the database files in your MySQL database. Database files are provided in hospitaldb).
<br> You can refer this video: https://youtu.be/9icY7xwXbJo

5. You can then run this web-application on your Tomcat server. For login use the credentials provided in loginPasswordsForDemo.txt) file. (Select correct role and fill the Username and Password) 
